...
const HeroSection = ({profile}:{profile:IProfile}) => {
  return (
    <section
      id="about"
    ...
    >
      ...
      <div className="max-w-xl text-center md:text-left">
        <h1 className="text-4xl md:text-5xl font-bold mb-4">
          Hi, I&apos;m <span className="text-gray-300">{profile.name}</span>
        </h1>
        <h1 className="text-4xl md:text-5xl font-bold mb-4">
      ...
      {/* Profile Image */}
      <div className="w-48 h-48 md:w-64 lg:w-96  lg:h-96 md:h-64 relative rounded-full overflow-hidden border-4 border-primary shadow-lg">
        <Image
